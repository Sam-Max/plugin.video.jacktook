import logging
from resources.lib.utils.kodi import ADDON_NAME, log, notify
from xbmcgui import DialogProgressBG
from resources.lib.api.jacktook.provider import (
    get_providers,
    send_to_providers,
    ProviderListener,
    ProviderResult,
...
def burst_search_movie(movie_id, query, year=None):
    return search(
        "search_movie",
        movie_id,
        query,
...
def burst_search_show(show_id, year):
    return search(
        "search_show",
        show_id,
        year=year,
...
def burst_search_season(show_id, season_number):
    return search(
        "search_season",
        show_id,
        int(season_number),
