...
ALPHANUMERIC_CHARS = rb"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:"
...
ERROR_LEVEL_TO_MICRO_MAPPING = {
    VERSION_M1: {None: 0},
    VERSION_M2: {ERROR_LEVEL_L: 1, ERROR_LEVEL_M: 2},
    VERSION_M3: {ERROR_LEVEL_L: 3, ERROR_LEVEL_M: 4},
    VERSION_M4: {ERROR_LEVEL_L: 5, ERROR_LEVEL_M: 6, ERROR_LEVEL_Q: 7},
}
...
ECC = {
    ...
    VERSION_M4: {
        ERROR_LEVEL_L: (EC(1, 24, 16),),
        ERROR_LEVEL_M: (EC(1, 24, 14),),
        ERROR_LEVEL_Q: (EC(1, 24, 10),),
    },
    1: {
        ERROR_LEVEL_L: (EC(1, 26, 19),),
        ERROR_LEVEL_M: (EC(1, 26, 16),),
        ERROR_LEVEL_Q: (EC(1, 26, 13),),
        ERROR_LEVEL_H: (EC(1, 26, 9),),
    },
    2: {
        ERROR_LEVEL_L: (EC(1, 44, 34),),
        ERROR_LEVEL_M: (EC(1, 44, 28),),
        ERROR_LEVEL_Q: (EC(1, 44, 22),),
        ERROR_LEVEL_H: (EC(1, 44, 16),),
    },
    3: {
        ERROR_LEVEL_L: (EC(1, 70, 55),),
        ERROR_LEVEL_M: (EC(1, 70, 44),),
        ERROR_LEVEL_Q: (EC(2, 35, 17),),
        ERROR_LEVEL_H: (EC(2, 35, 13),),
    },
    4: {
        ERROR_LEVEL_L: (EC(1, 100, 80),),
        ERROR_LEVEL_M: (EC(2, 50, 32),),
        ERROR_LEVEL_Q: (EC(2, 50, 24),),
        ERROR_LEVEL_H: (EC(4, 25, 9),),
    },
    5: {
        ERROR_LEVEL_L: (EC(1, 134, 108),),
        ERROR_LEVEL_M: (EC(2, 67, 43),),
        ERROR_LEVEL_Q: (EC(2, 33, 15), EC(2, 34, 16)),
        ERROR_LEVEL_H: (EC(2, 33, 11), EC(2, 34, 12)),
    },
    6: {
        ERROR_LEVEL_L: (EC(2, 86, 68),),
        ERROR_LEVEL_M: (EC(4, 43, 27),),
        ERROR_LEVEL_Q: (EC(4, 43, 19),),
        ERROR_LEVEL_H: (EC(4, 43, 15),),
    },
    7: {
        ERROR_LEVEL_L: (EC(2, 98, 78),),
        ERROR_LEVEL_M: (EC(4, 49, 31),),
