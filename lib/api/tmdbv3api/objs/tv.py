...
class TV(TMDb):
    ...
    def reviews(self, tv_id, page=1):
        ...
        """
        return self._request_obj(
            self._urls["reviews"] % tv_id, params=f"page={page}", key="results"
        )
    ...
    def similar(self, tv_id, page=1):
        ...
        """
        return self._request_obj(
            self._urls["similar"] % tv_id, params=f"page={page}", key="results"
        )
    ...
    def airing_today(self, page=1):
        ...
        """
        return self._request_obj(
            self._urls["airing_today"], params=f"page={page}", key="results"
        )
    ...
    def on_the_air(self, page=1):
        ...
        """
        return self._request_obj(
            self._urls["on_the_air"], params=f"page={page}", key="results"
        )
    ...
    def top_rated(self, page=1):
        ...
        """
        return self._request_obj(
            self._urls["top_rated"], params=f"page={page}", key="results"
        )
